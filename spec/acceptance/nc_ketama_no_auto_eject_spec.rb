...
describe 'nutcracker no auto eject service testing', :unless => UNSUPPORTED_PLATFORMS.include?(fact('osfamily')) do
  ...
  context 'should run puppet code to install ketama type distribution using one_at_a_time hash without auto eject' do
